...
import allKitImg from './all-kit.jpg'
import weightImg from './weight1.jpg'
import ffdImg from './ffd.jpg'
import module1Img from './module1.jpg'
import module2Img from './module2.jpg'
import module3Img from './module3.jpg'

<FadeImage src={allKitImg} alt="All Kit" title="The complete kit" layout="constrained" width={800} />
...
<FadeImage src={weightImg} alt="Convenient" title="Convenient to carry" layout="constrained" width={800} />
...
<FadeImage src={ffdImg} alt="First Field Dressing" title="Israeli army field dressing" layout="constrained" width={800} />
...
<FadeImage src={module1Img} alt="Module One" title="Module One in Aloksak" layout="constrained" width={800} />
...
<FadeImage src={module2Img} alt="Module two" title="Module Two in Aloksak" layout="constrained" width={800} />
...
<FadeImage src={module3Img} alt="Small Dressings Pack" title="Small dressings pack" layout="constrained" width={800} />
