...
<FadeImage src={allKitImg} alt="All Kit" title="The complete kit" layout="full-width" />
...
<FadeImage src={weightImg} alt="Convenient" title="Convenient to carry" layout="full-width" />
...
<FadeImage src={ffdImg} alt="First Field Dressing" title="Israeli army field dressing" layout="full-width" />
...
<FadeImage src={module1Img} alt="Module One" title="Module One in Aloksak" layout="full-width" />
...
<FadeImage src={module2Img} alt="Module two" title="Module Two in Aloksak" layout="full-width" />
...
<FadeImage src={module3Img} alt="Small Dressings Pack" title="Small dressings pack" layout="full-width" />
