...
import topImg from './img09.jpg'
import seamTensionImg from './IMG_2261.jpg'
import seamFailImg from './seam-fail.jpg'
import pitchedImg from './img07.jpg'
import underTarpImg from './img23.jpg'

<FadeImage src={topImg} alt="Rig 7 Tarp" title="Prototype Rig 7 tarp" layout="constrained" width={800} />
...
<FadeImage src={seamTensionImg} alt="Silnylon Rig 7" title="Silnylon Rig 7 with seam tension" layout="constrained" width={800} />
...
<FadeImage src={seamFailImg} alt="Seam failure" title="Seam sealing failure" layout="constrained" width={800} />
...
<FadeImage src={pitchedImg} alt="Pitched flat" title="No center seam dip" layout="constrained" width={800} />
...
<FadeImage src={underTarpImg} alt="Under a tarp" layout="constrained" width={800} />
